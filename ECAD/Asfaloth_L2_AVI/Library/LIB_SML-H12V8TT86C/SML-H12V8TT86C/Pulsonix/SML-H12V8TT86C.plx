...
(library Library_1
	...
	(patternDef "LEDC2012X80N" (originalName "LEDC2012X80N")
		(multiLayer
	...
	(symbolDef "SML-H12V8TT86C" (originalName "SML-H12V8TT86C")
	...
	(compDef "SML-H12V8TT86C" (originalName "SML-H12V8TT86C") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SML-H12V8TT86C"))
		(attachedPattern (patternNum 1) (patternName "LEDC2012X80N")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "755-SML-H12V8TT86C")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ROHM-Semiconductor/SML-H12V8TT86C?qs=HXFqYaX1Q2xM3o6aiCqz5g%3D%3D")
		(attr "Manufacturer_Name" "ROHM Semiconductor")
		(attr "Manufacturer_Part_Number" "SML-H12V8TT86C")
		(attr "Description" "Standard LEDs - SMD Standard LEDs - SMD Red 630nm 25mcd 2.2V ; 20mA; 0805 AECQ-101")
		(attr "<Hyperlink>" "https://www.mouser.in/ProductDetail/ROHM-Semiconductor/SML-H12V8TT86C?qs=HXFqYaX1Q2xM3o6aiCqz5g%3D%3D")
		(attr "<Component Height>" "0.8")
		(attr "<STEP Filename>" "SML-H12V8TT86C.stp")
