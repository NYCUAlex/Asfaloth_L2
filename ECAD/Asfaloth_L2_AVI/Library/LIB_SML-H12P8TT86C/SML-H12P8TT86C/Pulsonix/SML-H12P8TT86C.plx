...
(library Library_1
	...
	(symbolDef "SML-H12P8TT86C" (originalName "SML-H12P8TT86C")
	...
	(compDef "SML-H12P8TT86C" (originalName "SML-H12P8TT86C") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SML-H12P8TT86C"))
		...
		(attr "Mouser Part Number" "755-SML-H12P8TT86C")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/ROHM-Semiconductor/SML-H12P8TT86C?qs=HXFqYaX1Q2xINkpk%2F8IQZg%3D%3D")
		(attr "Manufacturer_Name" "ROHM Semiconductor")
		(attr "Manufacturer_Part_Number" "SML-H12P8TT86C")
		(attr "Description" "ROHM - SML-H12P8TT86C - CHIP LED, AEC-Q101, GREEN, 4MCD, 0805")
		(attr "<Hyperlink>" "")
