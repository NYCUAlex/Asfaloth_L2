...
(library Library_1
	...
	(patternDef "2828372" (originalName "2828372")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.54 4.1) (pt 7.62 4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.62 4.1) (pt 7.62 -4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.62 -4.1) (pt -2.54 -4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 -4.1) (pt -2.54 4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.14 4.1) (pt -2.54 4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 4.1) (pt -2.54 -4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 -4.1) (pt -3.14 -4.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "282837-2" (originalName "282837-2") (compHeader (numPins 2) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.te.com/commerce/DocumentDelivery/DDEController?Action=srchrtrv&DocNm=1-1773458-1_EURO_STYLE_QRG&DocType=Data%20Sheet&DocLang=English&PartCntxt=282837-2&DocFormat=pdf")
		(attr "<Component Height>" "10.3")
		(attr "<STEP Filename>" "282837-2.stp")
		(attr "<STEP Offsets>" "X=2.57;Y=-0.01;Z=4.84")
